...
export default function Home() {
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
        {statsData.map((statsData , index)=>(
         <div key={index} className="text-center">
          <div className="text-4xl font-bold text-blue-500 mb-2">{statsData.value}</div>
  ...
  <CardContent className="space-y-4 pt-4">
   ...
   <div className="container mx-auto px-4">
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <section className="py-20">
   <div className="container mx-auto px-4">
    <h2 className="text-3xl font-bold text-center mb-12"> Feedback from users</h2>
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
  ...
  <p className="text-gray-600">{testimonial.quote}</p>
   ...
   <div className="container mx-auto px-4 text-center">
    ...
    <p className="text-blue-100 mb-8 max-w-2xl mx-auto">Join our users who are already managing their finances smartly with Savvy</p>
    <Link href="/dashboard">
      <Button size="lg" className="bg-white text-blue-700 hover:bg-blue-50 animate-bounce">
      Start Your Journey
      </Button>
    </Link>
   </div>
